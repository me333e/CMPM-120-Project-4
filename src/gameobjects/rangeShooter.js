...
export class RangeShooter extends Phaser.GameObjects.Sprite {
    ...
    
    {
        ...
        this.damage = 2;
        this.bullet_asset = scene.textures.get('rangeProj');
        ...
        const upgradeButtons = [
            { active: upgradeActive, disabled: upgradeDisabled, x: x - 22, y: y - 65, afford: "upgrade", cost: '15' },
    ...
    preUpdate(time, delta) {
        ...
        if (enemy_array.length > 0) {
            ...
            if (this.last_attack + this.attack_speed < time){
                ...
                let b = new Bullet(this.scene, this.x, this.y, furthest_enemy, this.bullet_speed, this.damage, this.bullet_asset, 1);

...
export class ButtonPlacement extends Phaser.GameObjects.Sprite {
    ...
    
    {
        ...
        this.buildButton = scene.add.image(496, 130, 'buildButton').setOrigin(0);
        ...
        this.basicButton = scene.add.image(460, 123, basicB).setOrigin(0);
        ...
        this.basicButtonDisabled = scene.add.image(460, 123, basicBD).setOrigin(0);
